...
public class HomePageUKT extends PageObject {
    ...
    public void selecttourist() throws InterruptedException {
        ((JavascriptExecutor) getDriver()).executeScript("window.scrollBy(200,550)", "");
    ...
    public void clicktouristbutton() throws InterruptedException {
        tourismbutton.click();
    }

    public void visavalidation() throws InterruptedException {
        String titlevalid_act ="You won’t need a visa to come to the UK";
